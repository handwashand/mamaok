...
import 'admin_tarifs_model.dart';
export 'admin_tarifs_model.dart';

class AdminTarifsWidget extends StatefulWidget {
  const AdminTarifsWidget({
    Key? key,
  ...
  @override
  _AdminTarifsWidgetState createState() => _AdminTarifsWidgetState();
}

class _AdminTarifsWidgetState extends State<AdminTarifsWidget> {
  late AdminTarifsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminTarifsModel());
                          ...
                          child: StreamBuilder<List<PriceListRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<PriceListRecord>
                                  listViewPriceListRecordList = snapshot.data!;
