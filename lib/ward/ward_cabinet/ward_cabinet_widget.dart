...
import 'ward_cabinet_model.dart';
export 'ward_cabinet_model.dart';

class WardCabinetWidget extends StatefulWidget {
  const WardCabinetWidget({Key? key}) : super(key: key);

  @override
  _WardCabinetWidgetState createState() => _WardCabinetWidgetState();
}

class _WardCabinetWidgetState extends State<WardCabinetWidget> {
  late WardCabinetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WardCabinetModel());
