...
import 'home_ward_model.dart';
export 'home_ward_model.dart';

class HomeWardWidget extends StatefulWidget {
  const HomeWardWidget({Key? key}) : super(key: key);

  @override
  _HomeWardWidgetState createState() => _HomeWardWidgetState();
}

class _HomeWardWidgetState extends State<HomeWardWidget> {
  late HomeWardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeWardModel());
                          ...
                          child: Container(
                            ...
                            child: StreamBuilder<List<MainInfoRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<MainInfoRecord>
                                    listViewMainInfoRecordList = snapshot.data!;
                                return ListView.builder(
                                  padding: EdgeInsets.zero,
                                  shrinkWrap: true,
                                  scrollDirection: Axis.horizontal,
                                  itemCount: listViewMainInfoRecordList.length,
                          ...
                          child: StreamBuilder<List<MeetingsRecord>>(
                            stream: queryMeetingsRecord(
                              queryBuilder: (meetingsRecord) => meetingsRecord
                                  .where('IDWard', isEqualTo: currentUserUid)
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                'Вас просят подтвердить приглашение',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        '${containerUsersRecord?.displayName} ${containerUsersRecord?.fatherName} ${containerUsersRecord?.surname}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
