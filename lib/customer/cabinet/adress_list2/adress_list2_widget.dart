...
import 'adress_list2_model.dart';
export 'adress_list2_model.dart';

class AdressList2Widget extends StatefulWidget {
  const AdressList2Widget({Key? key}) : super(key: key);

  @override
  _AdressList2WidgetState createState() => _AdressList2WidgetState();
}

class _AdressList2WidgetState extends State<AdressList2Widget> {
  late AdressList2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdressList2Model());
