...
import 'test5_model.dart';
export 'test5_model.dart';

class Test5Widget extends StatefulWidget {
  const Test5Widget({Key? key}) : super(key: key);
...
class _Test5WidgetState extends State<Test5Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Test5Model());

    _model.minController ??= TextEditingController(
        text: FFAppState().FiltrExpierence > 0
            ? FFAppState().FiltrExpierence.toString()
            : null);
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Какой желаемый опыт компаньона (лет)',
