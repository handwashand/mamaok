...
import 'pay_customer_model.dart';
export 'pay_customer_model.dart';

class PayCustomerWidget extends StatefulWidget {
  const PayCustomerWidget({Key? key}) : super(key: key);

  @override
  _PayCustomerWidgetState createState() => _PayCustomerWidgetState();
}

class _PayCustomerWidgetState extends State<PayCustomerWidget> {
  late PayCustomerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PayCustomerModel());
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          if ((_model.summController.text != null &&
                            ...
                            _model.apiResultp0t = await UkassaCall.call(
